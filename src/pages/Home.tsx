  ...
  return (
    <div className="fade-up space-y-6">
      ...
      <div className="mb-6 ml-1 flex items-end justify-between">
        <div>
          {page === 1 && !keyword && !categoryId && (
            <p className="mb-1 text-[11px] font-medium uppercase tracking-[0.22em] text-gray-400">
              Posts
            </p>
          )}
        ...
        {!keyword && total > 5 && (
          <Link
            to={`/?page=${page + 1}`}
            className="text-xl font-medium text-gray-800 transition hover:text-gray-600"
          >
            更多文章 →
          </Link>
        )}
      ...
      <div className="card mt-12 flex justify-center p-6">
        <Pagination
          page={page}
          totalPage={totalPage}
          extra={{ category: categoryId, keyword }}
        />
      </div>
    </div>
  );
