...
export function CategoriesTags() {
  ...
  const btnCls =
    "shrink-0 rounded-xl bg-gray-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-gray-700 active:scale-[0.98] disabled:opacity-60 dark:bg-gray-200 dark:text-gray-900 dark:hover:bg-gray-300";
  ...
  return (
    <div className="fade-up space-y-6">
      ...
      <section className="card p-5 sm:p-6">
        ...
        {/* 列表 */}
        {categories.length === 0 ? (
          <EmptyState title="还没有分类" description="创建一个分类来归档文章" />
        ) : (
                  ...
                  <div className="flex w-full flex-col gap-2 sm:flex-row sm:items-center">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="rounded-lg bg-gray-900 px-3 py-2 text-xs font-medium text-white transition hover:bg-gray-700 disabled:opacity-60 dark:bg-gray-200 dark:text-gray-900 dark:hover:bg-gray-300"
                      >
                        保存
                      </button>
                      <button
                        onClick={() => setEditingCat(null)}
                        className="rounded-lg border border-gray-200 px-3 py-2 text-xs text-gray-500 transition hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800"
                      >
                        取消
                      </button>
                    </div>
                  ...
                  <>
                    ...
                    <div className="flex shrink-0 items-center gap-1.5">
                      <button
                        ...
                        className="rounded-lg px-2.5 py-1.5 text-xs font-medium text-blue-600 transition hover:bg-blue-50 sm:px-3 dark:hover:bg-blue-500/10"
                      >
                        编辑
                      </button>
                      <button
                        onClick={() => setDeletingCat(c)}
                        className="rounded-lg px-2.5 py-1.5 text-xs font-medium text-red-500 transition hover:bg-red-50 sm:px-3 dark:hover:bg-red-500/10"
                      >
                        删除
                      </button>
                    </div>
        ...
        {tags.length === 0 ? (
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            {tags.map((t) => (
              <span
                key={t.id}
                className="group inline-flex items-center gap-1 rounded-full bg-gray-100 px-3 py-1.5 text-sm text-gray-600 dark:bg-gray-800 dark:text-gray-300"
              >
                {editingTag?.id === t.id ? (
