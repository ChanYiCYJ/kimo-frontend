...
export function AgentPanel({ onClose, onInsertMessage, initUrl }: { onClose: () => void; onInsertMessage: (t: string) => void; initUrl?: string }) {
  ...
  const h = Math.max(360, window.innerHeight - 120);
