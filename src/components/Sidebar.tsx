  ...
  return (
    <div className="space-y-3">
      ...
      <section className="card p-3.5">
        <h3 className="mb-3 border-l-2 border-gray-900 pl-2.5 text-xs font-semibold uppercase tracking-wider text-gray-500">
          统计
        </h3>
        <div className="grid grid-cols-3 gap-2 text-center">
          <Link
            to="/"
            className="rounded-lg bg-gray-50 py-2 transition hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700"
          >
