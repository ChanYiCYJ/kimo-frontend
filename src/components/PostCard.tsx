...
export function PostCard({ post }: { post: ArticleListItem }) {
  return (
    <article className="card card-hover group flex flex-col gap-4 overflow-hidden p-4 md:flex-row md:gap-6">
      {/* 封面（原项目：md:w-60 / rounded-2xl） */}
      {post.cover_image && (
        <div className="aspect-[16/9] w-full shrink-0 overflow-hidden rounded-2xl bg-gray-100 transition-transform duration-300 md:aspect-auto md:h-44 md:w-60 dark:bg-gray-800">
          <img
